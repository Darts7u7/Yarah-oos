...
<CardGroup cols={2}>
  ...
  <Card title="Yarah CLI" icon="terminal" href="/quickstart">
    `npx @yarah/cli posthog setup` links your Yarah project to PostHog, then prints the wizard command.
  </Card>
</CardGroup>
