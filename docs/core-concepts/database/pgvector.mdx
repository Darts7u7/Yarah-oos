---
title: "pgvector"
description: "Use the pgvector extension shipped with every Yarah project to store embeddings and run semantic search, recommendations, and RAG queries in Postgres."
---

[pgvector](https://github.com/pgvector/pgvector) ships on every Yarah project. Use it for semantic search, recommendations, and [RAG](https://www.pinecone.io/learn/retrieval-augmented-generation/).
...
- [Model Gateway overview](/core-concepts/ai/overview) for the Yarah side of OpenRouter.
