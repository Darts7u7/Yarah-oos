...
- **Enlace de la CLI** — consulta la [Guía rápida](/quickstart) para ejecutar `npx @yarah/cli link --project-id <your-project-id>` y que el agente pueda leer el ID de tu proyecto y tus claves.
