---
title: Next.js
description: Aprende a crear un proyecto en Yarah y construir una aplicación Next.js con IA, autenticación, base de datos Postgres y almacenamiento en pocos pasos.
---

Aprenda cómo crear un proyecto Yarah y crear una aplicación Next.js usando herramientas de IA como Cursor.
...
**Cliente Yarah** en `lib/yarah.ts`:

```typescript lib/yarah.ts
...
export default async function SportsPage() {
  const { data: sports, error } = await yarah.database
    .from('sports')
    .select();
