---
title: Vue
description: Aprende a crear un proyecto en Yarah y construir una aplicación Vue con IA, autenticación, base de datos Postgres y almacenamiento usando el SDK oficial.
---

import Installation from '/snippets/sdk-installation.mdx';

Aprende a crear un proyecto de Yarah y a desarrollar una aplicación Vue utilizando herramientas de IA como Cursor.
