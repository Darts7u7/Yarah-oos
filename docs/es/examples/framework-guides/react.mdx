...
- **Enlace CLI** — vea el [Inicio rápido](/quickstart) para ejecutar `npx @yarah/cli link --project-id <your-project-id>` para que el agente pueda leer su ID de proyecto y claves.
