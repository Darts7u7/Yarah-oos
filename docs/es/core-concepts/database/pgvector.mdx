---
title: "pgvector"
description: "Almacena incrustaciones vectoriales y ejecuta búsqueda de similitud dentro de Postgres con pgvector en Yarah para casos de uso de IA, RAG y recomendaciones."
---

[pgvector](https://github.com/pgvector/pgvector) se envía en cada proyecto de Yarah. Úselo para búsqueda semántica, recomendaciones y [RAG](https://www.pinecone.io/learn/retrieval-augmented-generation/).
...
const yarah = createClient({ projectId: process.env.YARAH_PROJECT_ID });
...
await yarah.database.from('documents').insert({
  content: 'hello world',
...
- [Model Gateway overview](/core-concepts/ai/overview) para el lado de Yarah de OpenRouter.
