...
Rastrear y aplicar cambios SQL en orden. [Migrations](/core-concepts/database/migrations) se envían como archivos `.sql` simples en su repositorio, aplicados con `npx @yarah/cli db migrations up --all` o mediante la herramienta MCP.
