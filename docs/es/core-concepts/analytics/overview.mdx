...
<CardGroup cols={2}>
  ...
  <Card title="CLI de Yarah" icon="terminal" href="/quickstart">
    `npx @yarah/cli posthog setup` vincula su proyecto Yarah a PostHog, luego imprime el comando del asistente.
  </Card>
</CardGroup>
