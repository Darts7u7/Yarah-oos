...
<Frame caption="Navegador de almacenamiento: depósitos, listado de archivos y cargas, todo detrás del mismo RLS que la base de datos.">
  <img src="/images/storage-browser.png" alt="Navegador de almacenamiento del panel de Yarah que muestra un depósito de fotos y el listado de archivos" />
</Frame>
