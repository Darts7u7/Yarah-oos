...
<CardGroup cols={2}>
  <Card title="Yarah CLI" icon="terminal" href="/quickstart">
    `npx @yarah/cli webscraper apify connect` vincula su proyecto a Apify y luego inicia sesión en su agente local.
  </Card>
