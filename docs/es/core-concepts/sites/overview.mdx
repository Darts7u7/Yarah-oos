...
- Agrega variables de entorno seguras para el navegador desde el panel o con `npx @yarahdev/cli deployments env set`.
- Ejecuta `npx @yarahdev/cli deployments deploy ./frontend`.
