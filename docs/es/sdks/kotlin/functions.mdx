...
description: Invoca funciones sin servidor de Yarah desde Kotlin con el SDK oficial para ejecutar lógica de servidor, webhooks y tareas asíncronas en tu app Android.
---
...
val adminClient = createYarahClient(
