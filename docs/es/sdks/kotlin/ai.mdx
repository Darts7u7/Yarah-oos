...
description: Construye funciones de IA desde Kotlin con el SDK de Yarah usando la clave de OpenRouter aprovisionada, cuotas por proyecto y llamadas a modelos LLM.
---
...
Los métodos anteriores del SDK de IA de Kotlin de Yarah están deprecados como contenedores de compatibilidad. Usa el SDK de Yarah para base de datos, autenticación, almacenamiento, funciones y tiempo real; usa OpenRouter para llamadas de modelo.
...
Se dirigen al proxy de IA de Yarah deprecado. Las nuevas integraciones deben usar la clave de OpenRouter del panel y seguir los documentos actuales de la API de OpenRouter para parámetros de modelo y capacidades.
