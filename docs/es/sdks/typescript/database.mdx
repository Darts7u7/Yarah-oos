...
description: Operaciones de base de datos Postgres de tipo seguro con el SDK de TypeScript de Yarah para consultas, filtros, joins y mutaciones desde Node y navegador.
---
...
```tsx
import { useUser } from '@yarahdev/react'; // or '@yarahdev/react-router'
