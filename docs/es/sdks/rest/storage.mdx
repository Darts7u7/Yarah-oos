...
description: Almacena archivos, gestiona cubos y genera URLs firmadas a través de la API REST de Yarah desde cualquier cliente HTTP con autenticación JWT y S3.
---
...
Yarah admite dos tipos de backend de almacenamiento:
...
- **Almacenamiento local**: Carga directa a la API de Yarah
...
- **Almacenamiento local**: Descarga directa de la API de Yarah
