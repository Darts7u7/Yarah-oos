...
description: Construye funciones de IA desde Swift con el SDK de Yarah usando la clave de OpenRouter provisionada, cuotas por proyecto y llamadas a modelos LLM.
---
...
Los métodos anteriores del SDK de IA de Swift de Yarah están obsoletos y son envoltorios de compatibilidad. Utilice el SDK de Yarah para base de datos, autenticación, almacenamiento, funciones y tiempo real; utilice OpenRouter para llamadas de modelo.
...
## Métodos de IA de Yarah heredados
...
Se dirigen al proxy de IA de Yarah obsoleto. Las nuevas integraciones deben utilizar la clave de OpenRouter del panel de control y seguir la documentación actual de la API de OpenRouter para parámetros de modelo y capacidades.
