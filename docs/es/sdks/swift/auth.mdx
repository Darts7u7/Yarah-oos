...
Para usuarios que se registran con correo electrónico, el backend de Yarah ofrece tres opciones:
...
- `redirectTo` (`String`) - URL de devolución de llamada donde Yarah redirigirá después de la autenticación
