...
description: Instala el SDK oficial de Swift de Yarah vía Swift Package Manager para usar autenticación, base de datos, almacenamiento y tiempo real en Apple.
---

import SwiftSdkInstallation from '/snippets/swift-sdk-installation.mdx';

El SDK de Swift de Yarah proporciona un cliente Swift nativo para interactuar con servicios de Yarah desde aplicaciones iOS, macOS, tvOS y watchOS.
...
1. File → Add Packages...
2. Ingrese: `https://github.com/yarah/yarah-swift.git`
