---
title: "Autoalojar Yarah en Dokploy"
description: "Autoaloja Yarah en Dokploy como aplicación Compose, con la imagen de Postgres construida desde el repositorio para coincidir con la versión desplegada."
---

# Autoalojar Yarah en Dokploy

Esta guía explica cómo autoalojar la plataforma Yarah en [Dokploy](https://dokploy.com), un PaaS de código abierto que ejecutas en tu propio servidor.
...
Solo `yarah` necesita un dominio. Postgres, PostgREST y el runtime de Deno permanecen en la red interna de Dokploy.
