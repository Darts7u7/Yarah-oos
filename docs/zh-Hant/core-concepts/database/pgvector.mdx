---
title: "pgvector"
description: "在 Yarah 的 Postgres 中啟用 pgvector 儲存嵌入向量，並執行相似性搜尋，打造 RAG 與語義檢索功能。"
---

[pgvector](https://github.com/pgvector/pgvector) 在每個 Yarah 專案上提供。將其用於語義搜尋、推薦和 [RAG](https://www.pinecone.io/learn/retrieval-augmented-generation/)。
...
- [Model Gateway overview](/core-concepts/ai/overview) 用於 OpenRouter 的 Yarah 端。
