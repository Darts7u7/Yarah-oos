---
title: S3 相容閘道
description: "透過 S3 相容閘道以任何 AWS SigV4 用戶端存取 Yarah Storage，重用既有的 aws-cli、SDK 與備份工具。"
---

Yarah Storage 在 `/storage/v1/s3` 處使用 [AWS S3 通訊協定](https://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html)。僅限雲端專案。
