---
title: Yarah REST API 概覽
description: "透過 HTTP 以任何語言直接呼叫 Yarah 身份驗證、資料庫、儲存與函式，使用 API 金鑰、JWT 與標準 REST 慣例。"
---

Yarah REST API 提供對所有 Yarah 服務的直接 HTTP 存取。當您需要與沒有官方 SDK 的語言或平台整合時，請使用這種方式。
