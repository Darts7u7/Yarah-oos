---
title: OAuth Server
description: Use Yarah as an OAuth 2.0 identity provider with PKCE so third-party apps, MCP tools, and CLI clients can sign in users against your project.
---

## Overview

Yarah can function as an OAuth 2.0 identity provider, allowing third-party applications to authenticate users with "Sign in with Yarah". This enables developers building on your platform to leverage Yarah's authentication system without managing their own user credentials.

## Use Cases

<CardGroup cols={2}>
  <Card title="Developer Platforms" icon="code">
    Enable third-party developers to build integrations with "Sign in with Yarah" while you maintain control over user data access.
  </Card>
  ...
  <Card title="Partner Applications" icon="handshake">
    Allow partner applications to authenticate users against your Yarah project without sharing credentials.
  </Card>
...
Yarah implements the **Authorization Code flow with PKCE** (Proof Key for Code Exchange), the most secure OAuth flow for both web and native applications.
...
<Steps>
  <Step title="Register Your Application">
    Contact Yarah to register your application as an OAuth client. You'll receive:
...
<Card title="OAuth Example Repository" icon="github" href="https://github.com/Darts7u7/Yarah-oauth-example">
  Complete working example showing how to integrate "Sign in with Yarah" into your application.
</Card>
