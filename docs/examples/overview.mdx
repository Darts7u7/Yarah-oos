---
title: Yarah cookbook and framework examples
description: Browse Yarah examples for Next.js, React, Vue, Nuxt, and Svelte, plus AI prompts, setup guides, and community projects to build full-stack apps.
---

A collection of practical examples and guides for building with Yarah - the fastest way to build full-stack applications with PostgreSQL, authentication, storage, AI, and serverless functions.
...
Ready-to-use guides that show how to build with Yarah using popular frameworks and AI tools.
...
Community-built applications that demonstrate real-world implementations of Yarah.

<Card title="View Showcase" icon="star" href="/showcase">
  Explore projects built with Yarah
</Card>
...
Have a project built with Yarah? We'd love to feature it!

<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/Darts7u7/Yarah-oos/issues">
    Submit your project or example
  </Card>

  <Card title="Discord Community" icon="discord" href="https://yarah.dev/community">
