---
title: Nuxt
description: Create an Yarah project and build a full-stack Nuxt app with the CLI and MCP, using AI editors like Cursor for schemas, queries, and deploys.
---

import Installation from '/snippets/sdk-installation.mdx';

Learn how to create an Yarah project and build a Nuxt app using AI tools like Cursor.

## 1. Create an Yarah project

Create a new Yarah project at [yarah.dev](https://yarah.dev).

## 2. Connect Yarah

Two pieces:

- **CLI link** — see the [Quickstart](/quickstart) to run `npx @yarahdev/cli link --project-id <your-project-id>` so the agent can read your project ID and keys.
