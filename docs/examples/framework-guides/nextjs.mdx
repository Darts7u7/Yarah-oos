---
title: Next.js
description: Create an Yarah project and build a full-stack Next.js app with the CLI and MCP, using AI editors like Cursor for schemas, queries, and deploys.
---

Learn how to create an Yarah project and build a Next.js app using AI tools like Cursor.
