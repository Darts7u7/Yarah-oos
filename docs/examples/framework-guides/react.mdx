---
title: React
description: Create an Yarah project and build a full-stack React app with the CLI and MCP, using AI editors like Cursor for schemas, queries, and deploys.
---

import Installation from '/snippets/sdk-installation.mdx';

Learn how to create an Yarah project and build a React app using AI tools like Cursor.
