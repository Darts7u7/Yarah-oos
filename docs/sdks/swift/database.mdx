...
description: Run type-safe Postgres queries, inserts, updates, and deletes from iOS and macOS apps with the Yarah Swift SDK using Codable models and JWT auth.
---
