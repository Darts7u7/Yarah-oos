...
description: Invoke Yarah serverless edge functions from iOS and macOS apps with the Yarah Swift SDK, passing typed request bodies and decoding JSON responses.
---
