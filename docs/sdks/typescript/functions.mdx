...
description: Invoke Yarah serverless edge functions by slug from browser or Node.js apps with the Yarah TypeScript SDK, passing typed request and response payloads.
---
