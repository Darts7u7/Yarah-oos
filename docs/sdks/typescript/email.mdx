...
description: Send transactional HTML emails to one or many recipients with the Yarah TypeScript SDK, including CC, BCC, reply-to, and Custom SMTP support.
---
