---
title: TypeScript and JavaScript SDK for Yarah
description: Install and initialize the official Yarah TypeScript SDK in Node, browsers, and edge runtimes to use auth, database, storage, and realtime.
---

The Yarah TypeScript SDK provides a type-safe client for interacting with Yarah services from JavaScript and TypeScript applications.
