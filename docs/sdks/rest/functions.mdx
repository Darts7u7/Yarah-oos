...
description: Invoke and manage serverless edge functions over HTTP with the Yarah REST API, running on Deno Subhosting in the cloud or locally in Docker.
---
...
<Note>
Currently, Yarah only supports JavaScript/TypeScript functions running in a Deno environment.
</Note>
