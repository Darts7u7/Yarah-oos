---
title: Yarah REST API overview
description: Call Yarah auth, database, storage, and functions directly over HTTP with any language, using API keys, JWTs, and standard REST conventions.
---

The Yarah REST API provides direct HTTP access to all Yarah services. Use this when you need to integrate with languages or platforms without an official SDK.
