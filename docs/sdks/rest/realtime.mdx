...
description: Manage Yarah realtime channels, inspect message history, tune retention, and publish or subscribe with the raw Socket.IO surface over the REST API.
---
...
Install the Socket.IO client when you are not using the Yarah SDK:
