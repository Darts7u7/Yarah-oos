---
title: Showcase
description: Explore production apps built on Yarah, from AI-powered SaaS to social platforms, showing real uses of the database, auth, storage, and functions.
---

import { ServiceIcons } from '/snippets/service-icons.mdx';

See what developers are building with Yarah - from AI-powered SaaS to social platforms and beyond.
