---
title: "Overview"
description: "Yarah is the open-source backend for agentic coding, bundling Postgres, auth, storage, realtime, functions, and a model gateway behind one CLI and MCP."
---
...
Yarah gives your coding agent Database, Authentication, Storage, Realtime, Edge Functions, Sites, and a Model Gateway to ship full-stack apps end to end.

## Connect first

Required setup. Pick one path to link your environment to Yarah before you start building. Start with the CLI for a universal terminal-based setup; add MCP if your editor speaks it (Claude Code, Cursor, Windsurf, Codex). You can run both side by side.

<CardGroup cols={2}>
  <Card title="Connect via CLI" icon="terminal" href="/quickstart">
    `npx @yarahdev/cli login` and link a project. Works in any terminal, MCP not required.
  </Card>
...
Looking for instructions for a specific tool? Browse the [agent directory](https://yarah.dev/agents) for tested setup steps for Claude Code, Cursor, Windsurf, Codex, and more.
...
Track new features and fixes in the [changelog](https://yarah.dev/changelogs).
