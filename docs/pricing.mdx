---
title: "Pricing FAQ"
description: "Yarah free and paid plan limits, what's included, how usage-based billing and overages work, and how to check current usage and reset dates."
---

Yarah has a free tier for prototypes and side projects, and paid plans for
production. This page mirrors the [pricing page](https://yarah.dev/pricing).
...
[Contact us](https://yarah.dev/pricing) for Enterprise.
...
<AccordionGroup>
  ...
  <Accordion title="How does custom compute billing work?">
    ...
    also comes with **$10 of Yarah Compute credits** to offset it.
  </Accordion>

  <Accordion title="What happens after I use up the $10 compute credit?">
    Nothing stops — the $10 monthly Yarah Compute credit (on Pro) covers the
...
<Card title="See full pricing" icon="tag" href="https://yarah.dev/pricing">
