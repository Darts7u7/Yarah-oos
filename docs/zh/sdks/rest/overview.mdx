---
title: Yarah REST API 概览
description: 通过 HTTP 使用任何语言，通过 API 密钥、JWT 和标准 REST 约定，直接调用 Yarah 认证、数据库、存储和函数。
---

Yarah REST API 提供对所有 Yarah 服务的直接 HTTP 访问。当您需要与没有官方 SDK 的语言或平台集成时，请使用这种方式。
