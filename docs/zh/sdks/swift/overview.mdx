...
description: 通过 Swift Package Manager 安装和初始化官方 Yarah Swift SDK，以在 Apple 平台上使用身份验证、数据库、存储和实时功能。
---

import SwiftSdkInstallation from '/snippets/swift-sdk-installation.mdx';

Yarah Swift SDK 为从 iOS、macOS、tvOS 和 watchOS 应用与 Yarah 服务交互提供了原生 Swift 客户端。
...
或通过 Xcode 添加：
1. File → Add Packages...
2. 输入：`https://github.com/yarah/yarah-swift.git`
