---
title: "将 Yarah 自托管到 Dokploy"
description: "在 Dokploy 上以 Compose 应用部署 Yarah 后端，Postgres 镜像从仓库构建，配置始终与所部署的版本一致。"
---

# 将 Yarah 自托管到 Dokploy

本指南介绍如何在 [Dokploy](https://dokploy.com) 上自托管 Yarah 平台。Dokploy 是一个跑在你自己服务器上的开源 PaaS。
...
只有 `yarah` 需要域名。Postgres、PostgREST 和 Deno 运行时都留在 Dokploy 的内部网络里。
