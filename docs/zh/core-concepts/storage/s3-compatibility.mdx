---
title: S3 兼容网关
description: 通过 /storage/v1/s3 端点使用任意 AWS SigV4 客户端访问 Yarah Storage，兼容 S3 协议，便于迁移现有工具链，仅限云项目。
---

Yarah Storage 在 `/storage/v1/s3` 处使用 [AWS S3 协议](https://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html)。仅限云项目。
