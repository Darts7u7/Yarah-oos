---
title: "产品"
description: "Yarah 全部产品概览：数据库、身份验证、存储、函数、实时、AI 网关、支付、分析、网站与自定义计算，全部通过统一 REST、JWT、MCP 与 SDK 公开。"
---

Yarah 提供十个产品，每个产品都通过相同的 REST 表面、相同的 JWT 身份验证、相同的 MCP 服务器和相同的 SDK 公开。
...
<CardGroup cols={2}>
  ...
  <Card title="模型网关" icon="sparkles" href="/core-concepts/ai/overview">
    OpenRouter 支持的聊天、流式传输和嵌入通过一个 Yarah 管理的密钥。按项目配额和使用跟踪。
  </Card>

  <Card title="网站" icon="globe" href="/core-concepts/sites/overview">
    将前端部署到 Yarah 管理的托管并自动将其链接到您的项目后端。
  </Card>
