---
title: 合作伙伴集成
description: 了解如何通过联合品牌或白标合作伙伴计划集成 Yarah，为客户提供托管后端平台，包括收入分成、专属仪表板与定制域名支持。
---

## 概述

Yarah 提供两种合作伙伴模式，能够将我们的后端即服务（Backend-as-a-Service）平台无缝集成到您的应用程序中。无论您是在寻找联合品牌解决方案，还是完全白标的体验，我们都有适合您的合作伙伴模式。

## 合作伙伴模式

<CardGroup cols={2}>
  <Card title="联合品牌合作伙伴关系" icon="handshake">
    非常适合希望将 Yarah 与自身服务一并提供的平台。
    集成过程非常简单——开发者只需一键即可连接到 Yarah 平台，无需复杂的 OAuth 流程。
  </Card>
...
<Steps>
  <Step title="申请合作伙伴关系">
    通过我们的[合作伙伴邮箱](mailto:partnerships@yarah.dev)提交您的合作伙伴申请。
...
### 联合品牌功能
在联合品牌模式下，开发者明确知道自己是 Yarah 平台的用户（通过相同的电子邮件地址关联）。登录 Yarah 平台后，开发者对通过合作伙伴创建的项目拥有完整的管理权限，并需要按照 Yarah 的计费方案付费。

合作伙伴平台可以：
- 将用户账户（姓名、邮箱）与 Yarah 同步
- 将项目同步到 Yarah
- 查询项目连接信息，以利用已完成的后端能力。

### 白标功能
在白标模式下，开发者不知道 Yarah 的存在，也无法在 Yarah 平台上看到合作伙伴创建的项目。
...
<Tabs>
  <Tab title="联合品牌 API">
    ...
    **响应：**
    ...
    #### 处理项目数量限制
    注意：由于 Yarah 免费方案存在项目数量限制，来自合作伙伴平台的项目同步操作可能会失败。在这种情况下，响应内容将为：
...
### 项目区域取值
Yarah 提供全球化的部署能力。每个项目都可以部署到不同的区域：
- `us-east` - 美国东海岸
- `us-west` - 美国西海岸
- `ap-southeast` - 亚太东南
- `eu-central` - 欧洲中部
...
- 与我们的团队安排一次[技术评审](https://calendly.com/tony-chang-yarah/45min)
