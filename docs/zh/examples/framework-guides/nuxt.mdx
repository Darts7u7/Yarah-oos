---
title: Nuxt
description: 了解如何创建 Yarah 项目并使用 Cursor、Claude 等 AI 工具构建 Nuxt 3 全栈应用，接入身份验证、Postgres 数据库、存储与实时通道。
---

import Installation from '/snippets/sdk-installation.mdx';

了解如何创建 Yarah 项目，并使用 Cursor 等 AI 工具构建 Nuxt 应用。

## 1. 创建 Yarah 项目

在 [yarah.dev](https://yarah.dev) 创建一个新的 Yarah 项目。

## 2. 连接 Yarah

分为两部分：

- **CLI 链接** — 参阅 [快速入门](/quickstart)，运行 `npx @yarahdev/cli link --project-id <your-project-id>`，让智能体能够读取你的项目 ID 和密钥。
