---
title: Svelte
description: 了解如何创建 Yarah 项目并使用 Cursor、Claude 等 AI 工具构建 SvelteKit 全栈应用，接入身份验证、Postgres 数据库、存储与实时更新。
---

import Installation from '/snippets/sdk-installation.mdx';

了解如何创建 Yarah 项目，并使用 Cursor 等 AI 工具构建 Svelte 应用。
