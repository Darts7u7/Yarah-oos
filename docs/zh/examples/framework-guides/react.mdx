---
title: React
description: 了解如何创建 Yarah 项目并使用 Cursor、Claude 等 AI 工具构建 React 单页应用，涵盖 SDK 安装、身份验证、Postgres 查询与存储上传。
---

import Installation from '/snippets/sdk-installation.mdx';

了解如何创建 Yarah 项目并使用 AI 工具（如 Cursor）构建 React 应用程序。
