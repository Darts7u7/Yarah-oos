export const ecommercePlatformPrompt = {
  ...
  prompt: `Build an app similar to a modern online store using Yarah as the backend platform that has these features:
...
• Stores product images in Yarah storage`,
