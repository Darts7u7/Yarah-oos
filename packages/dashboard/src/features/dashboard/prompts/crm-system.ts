export const crmSystemPrompt = {
  ...
  prompt: `Build a lightweight CRM app using Yarah as the backend platform with these features:
...
• File attachments stored in Yarah storage and shown on the deal page`,
