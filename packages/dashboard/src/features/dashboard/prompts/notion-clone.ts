export const notionClonePrompt = {
  ...
  prompt: `Make a notes app like Notion using Yarah as the backend platform with these features:
...
• Optional file attachments stored in Yarah storage and shown inside the page`,
